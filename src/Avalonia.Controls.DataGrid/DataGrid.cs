...
internal
    ...
    partial class DataGrid : TemplatedControl
    {
        ...
        private IList<DataGridColumnDefinition> _columnDefinitionsSource;
        private INotifyCollectionChanged _columnDefinitionsNotifications;
        private bool _syncingColumnDefinitions;
        private bool _pendingColumnDefinitionsApply;
        private readonly Dictionary<DataGridColumnDefinition, DataGridColumn> _columnDefinitionMap = new();
        private readonly HashSet<DataGridColumn> _definitionColumns = new();
        private int? _columnDefinitionsThreadId;
        ...
        internal
#endif
        IList<DataGridColumnDefinition> ColumnDefinitionsSource
        {
            get => _columnDefinitionsSource;
            set => SetColumnDefinitionsSource(value);
        }
        ...
        private DataGridColumn ResolveSearchColumn(SearchResult result)
        {
            ...
            if (result.ColumnId is DataGridColumnDefinition definition)
            {
                return FindColumnByDefinition(definition);
            }
